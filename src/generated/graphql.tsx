...
/**
 * __useAllShipsQuery__
 *
 * To run a query within a React component, call `useAllShipsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllShipsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllShipsQuery({
 *   variables: {
 *   },
 * });
 */
export function useAllShipsQuery(baseOptions?: Apollo.QueryHookOptions<AllShipsQuery, AllShipsQueryVariables>) {
        return Apollo.useQuery<AllShipsQuery, AllShipsQueryVariables>(AllShipsDocument, baseOptions);
      }
export function useAllShipsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllShipsQuery, AllShipsQueryVariables>) {
          return Apollo.useLazyQuery<AllShipsQuery, AllShipsQueryVariables>(AllShipsDocument, baseOptions);
        }
export type AllShipsQueryHookResult = ReturnType<typeof useAllShipsQuery>;
export type AllShipsLazyQueryHookResult = ReturnType<typeof useAllShipsLazyQuery>;
export type AllShipsQueryResult = Apollo.QueryResult<AllShipsQuery, AllShipsQueryVariables>;